...
module.exports = {
  ...
  CRYPTOMUS_BASE_URL: process.env.CRYPTOMUS_BASE_URL,
  CRYPTOMUS_PAYMENT_KEY: process.env.CRYPTOMUS_PAYMENT_KEY,
  CRYPTOMUS_PAYOUT_KEY: process.env.CRYPTOMUS_PAYOUT_KEY,
  CRYPTOMUS_MERCHANT_ID: process.env.CRYPTOMUS_MERCHANT_ID,
  CRYPTOMUS_WEBHOOK_SECRET: process.env.CRYPTOMUS_WEBHOOK_SECRET,
  CRYPTOMUS_WEBHOOK_URL: process.env.CRYPTOMUS_WEBHOOK_URL,
  CRYPTOMUS_SUCCESS_URL: process.env.CRYPTOMUS_SUCCESS_URL,
  validateEnvVars
};